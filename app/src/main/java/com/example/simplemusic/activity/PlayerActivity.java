            ...
            case R.id.play_mode:
                ...
                switch (mode) {
                    case Utils.TYPE_ORDER:
                        ...
                        Toast.makeText(PlayerActivity.this, "Single", Toast.LENGTH_SHORT).show();
                    ...
                    case Utils.TYPE_SINGLE:
                        ...
                        Toast.makeText(PlayerActivity.this, "Shuffle", Toast.LENGTH_SHORT).show();
                        btnPlayMode.setImageResource(R.drawable.ic_random);
                        break;
                    case Utils.TYPE_RANDOM:
                        serviceBinder.setPlayMode(Utils.TYPE_ORDER);
                        Toast.makeText(PlayerActivity.this, "List", Toast.LENGTH_SHORT).show();
